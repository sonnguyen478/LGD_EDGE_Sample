        ...
        private void fnCAM_Initialize()
        {
            ...
            try
            {
                ...
                if (bIsOpen == true)
                {
                    ...
                    axCVgrabber3.CamPort = 2; axCVgrabber3.Image = axCVimage3.Image;
                    axCVgrabber4.CamPort = 3; axCVgrabber4.Image = axCVimage4.Image;
                    axCVgrabber5.CamPort = 0; axCVgrabber5.Image = axCVimage5.Image;
                    axCVgrabber6.CamPort = 1; axCVgrabber6.Image = axCVimage6.Image;
                    axCVgrabber7.CamPort = 2; axCVgrabber7.Image = axCVimage7.Image;
                    axCVgrabber8.CamPort = 3; axCVgrabber8.Image = axCVimage8.Image;
                }
            }
            catch (Exception ex)
            {
                ...
                for (int idx = 0; idx < axImageList.Length; idx++)
                {
                    if (true == axImageList[idx].Snap())
                    {
                        ...
                        if (chkSnapFileSave.Checked == true)
                        {
                            ...
                            string filePath = string.Format("CAM_{0}_{1}", (idx + 1).ToString("00"), snapDate);
                            axImageList[idx].SaveImage(string.Format("{0}{1}.jpg", @"D:\SNAPTEST\", filePath));
                        }
                    }
                }
            }
